...
if (Input::exists()) {
    if (Token::check(Input::get('token'))) {
        if ($validate->passed()) {
            $current_user->update(['username' => Input::get('username'), 'status_user' => Input::get('status_user')]);
...
<!--         </div>-->
         ...
         <form action="" method="post" class="form">
           <div class="form-group">
             ...
             <input type="text" id="username" name="username" class="form-control" value="<?php echo $current_user->data()->username; ?>">
           </div>
           <div class="form-group">
